      ...
      {schedules.map((s) => (
        <div key={s.id} style={styles.card}>
          <div style={styles.header}>
            ...
            <span style={{ ...styles.pill, background: s.enabled ? "var(--color-success-soft)" : "var(--color-neutral-soft)", color: s.enabled ? "var(--color-success)" : "var(--color-neutral)" }}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { background: "var(--color-bg)", border: "1px solid var(--color-border)", borderRadius: "var(--radius-md)", padding: "var(--space-4)", display: "flex", flexDirection: "column", gap: "var(--space-2)" },
  ...
  pill: { fontSize: "var(--text-xs)", fontWeight: 600, padding: "2px 7px", borderRadius: "var(--radius-pill)", marginLeft: "auto" },
