...
use pond_core::domain::event::{Event, EventQuery};
use pond_core::ports::event_log::{EventLog, EventLogRepository, LogEntry};
...
mod event_log_tests {
    ...
    use pond_core::domain::event::{AttributeValue, Event, EventCategory, EventQuery, PrivacySensitivity};
