...
impl MemoryConsolidator for LlmMemoryConsolidator {
    async fn consolidate(
        ...
        let provider = {
            ...
            guard.as_ref().cloned().ok_or_else(|| anyhow!("no LLM provider"))?
        };
