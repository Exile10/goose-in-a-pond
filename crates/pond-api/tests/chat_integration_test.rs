...
#[async_trait::async_trait]
impl pond_core::ports::agent::Agent for ToolEmittingMockAgent {
    async fn chat(
        &self,
        _request: pond_core::ports::agent::AgentRequest,
    ) -> anyhow::Result<pond_core::ports::agent::AgentResponse> {
        Ok(pond_core::ports::agent::AgentResponse {
    ...
    async fn chat_stream(
        &self,
        request: pond_core::ports::agent::AgentRequest,
...
async fn make_app_with_agent(
    agent: Arc<dyn pond_core::ports::agent::Agent>,
