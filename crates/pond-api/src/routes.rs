...
async fn chat_stream(
    ...
    let stream = async_stream::stream! {
        ...
        // Track context window fill rate and emit warnings before the
        // "context cliff" where quality degrades on small-context models.
        if settings.context_monitor_enabled {
            ...
            let context_limit = if settings.context_window_override > 0 {
                ...
                // Use the model's capabilities to determine context window
