...
This file provides guidance to coding agents working in this repository. It is the tracked,
tool-agnostic version of what used to live in `CLAUDE.md`; `CLAUDE.md` is now gitignored and
personal, so anything that belongs to the project — not to one person's setup — goes here.
