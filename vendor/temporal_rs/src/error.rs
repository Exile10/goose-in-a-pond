...
impl From<icu_calendar::error::DateAddError> for TemporalError {
    fn from(_error: icu_calendar::error::DateAddError) -> Self {
        TemporalError::range().with_enum(ErrorMessage::DateOutOfRange)
    }
}
...
impl ErrorMessage {
    pub fn to_string(self) -> &'static str {
        match self {
            ...
            Self::Icu4xUntil => "Calendar arithmetic error.",
        }
    }
}
