...
**PAI-5 stopped being design-only on 2026-08-06** (P1 and P2) and reached five landed phases on
2026-08-07 (P4 and P6). **PAI-6 stopped being design-only on 2026-08-07** (P1 and P2) and reached a
third landed phase on 2026-08-09 (P3). So **six of the eight workstreams now have landed code**:
PAI-1 complete, PAI-2 through P8a, PAI-3, PAI-4, PAI-5 and PAI-6. **PAI-7 and PAI-8 are still design
only** and are the whole of the remaining programme. That order is forced rather than chosen: PAI-7
depends on PAI-6 and PAI-8 on PAI-7, so PAI-7 P4 (the `proactive-reviewer` role) cannot start until
PAI-6 has an orchestrator a caller can reach, and PAI-8's P8 cannot start until PAI-7 has a proposer
to wire an ingest event into. Two of the eight are code-landed with their own deciding
